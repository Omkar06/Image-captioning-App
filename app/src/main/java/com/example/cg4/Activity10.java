    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v1.putExtra(Intent.EXTRA_SUBJECT, "I don’t know what’s tighter, our jeans or our friendship.");
        ...
        s2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v2.putExtra(Intent.EXTRA_SUBJECT, "Friends are like stars. You may not see them all the time, but they are for sure there.");
        ...
        s3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v3.putExtra(Intent.EXTRA_SUBJECT, "When the teacher says “group”, I automatically look over to my best friend.");
        ...
        s4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v4.putExtra(Intent.EXTRA_SUBJECT, "Friendship isn’t a big thing, it’s a million little things.");
        ...
        s5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v5.putExtra(Intent.EXTRA_SUBJECT, "If you don’t own matching shirts, are you really friends?");
        ...
        s6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v6.putExtra(Intent.EXTRA_SUBJECT, "If your friends don’t make fun of you, they’re not really your friends.");
