    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v1.putExtra(Intent.EXTRA_SUBJECT, "We may encounter many defeats, but we must not be defeated.");
        ...
        s2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v2.putExtra(Intent.EXTRA_SUBJECT, "We must embrace pain and burn it as fuel for our journey");
        ...
        s3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v3.putExtra(Intent.EXTRA_SUBJECT, "You have to fight through some bad days to earn the best days of your life");
        ...
        s4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v4.putExtra(Intent.EXTRA_SUBJECT, "Strength does not come from physical capacity. It comes from an indomitable will. ");
        ...
        s5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v5.putExtra(Intent.EXTRA_SUBJECT, "The only person you are destined to become is the person you decide to be.");
        ...
        s6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v6.putExtra(Intent.EXTRA_SUBJECT, "You miss 100 percent of the shots you never take");
