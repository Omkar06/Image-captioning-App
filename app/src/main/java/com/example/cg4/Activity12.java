    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v1.putExtra(Intent.EXTRA_SUBJECT, "CAPTION 1");
        ...
        s2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v2.putExtra(Intent.EXTRA_SUBJECT, "CAPTION 2");
        ...
        s3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v3.putExtra(Intent.EXTRA_SUBJECT, "CAPTION 3");
        ...
        s4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v4.putExtra(Intent.EXTRA_SUBJECT, "CAPTION 4");
        ...
        s5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v5.putExtra(Intent.EXTRA_SUBJECT, "CAPTION 5");
        ...
        s6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v6.putExtra(Intent.EXTRA_SUBJECT, "CAPTION 6");
